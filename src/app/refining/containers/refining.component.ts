...
export class RefiningComponent implements OnInit, OnDestroy {
  ...
  priceForm = new FormGroup({
    ...
    하급오레하: new FormControl(11),
    중급오레하: new FormControl(12),
    상급오레하: new FormControl(24),
    ...
    은총: new FormControl(48.7),
    축복: new FormControl(120.7),
    가호: new FormControl(230.5),
    재봉술기본: new FormControl(36),
    재봉술응용: new FormControl(15),
    재봉술심화: new FormControl(693),
    야금술기본: new FormControl(62),
    야금술응용: new FormControl(34),
    야금술심화: new FormControl(1576),
